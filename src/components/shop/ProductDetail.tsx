...
export default function ProductDetail({ setView, addToCart }: ProductDetailProps) {
  ...
  const sampleProduct: CartItem = selectedProduct ? {
    ...
    weight: displayVariantName,
    quantity: 1
  } : { id: 99, name: 'Organic Premium Carrots', price: 80, oldPrice: 95, img: '', weight: '1 KG', quantity: 1 }
    ...
    <div className="bg-white w-full p-5 md:p-20 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-base text-[#6B7280] leading-relaxed mb-6 line-clamp-2 md:line-clamp-3 whitespace-pre-wrap">{parseBoldText(selectedProduct?.shortDesc || 'High quality product. Check details below.')}</p>
